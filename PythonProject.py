...
rtf_bg = 'DeepPink'  # Right Top Frame Background Color
rbf_bg = 'Yellow'  # Right Bottom Frame Background Color
btn_hlb_bg = 'LightBlue'  # Background color for Head Labels and Buttons

lbl_font = ('Helvetica', 14)  # Font for all labels
entry_font = ('Times New Roman', 13)  # Font for all Entry widgets
btn_font = ('Comic Sans MS', 12)
...
Label(root, text='THE LIBRARY ', font=("Noto Sans CJK TC", 15, 'bold'), bg=btn_hlb_bg, fg='Black').pack(side=TOP, fill=X)
...
# Right Bottom Frame
Label(RB_frame, text='BOOKS LOG', bg=rbf_bg, font=("Noto Sans CJK TC", 15, 'bold')).pack(side=TOP, fill=X)
